    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('team', '团队'), ('group', '群聊'), ('private', '私聊')], default='team', max_length=10, verbose_name='团队类型')),
                ...
                ('user1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chat_group_as_user1', to='user.user')),
                ('user2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chat_group_as_user2', to='user.user')),
            ],
        ),
        migrations.CreateModel(
